...
/* Define to the PLib interface age */
#define PLIB_INTERFACE_AGE 0

/* Define to the PLib major version */
#define PLIB_MAJOR_VERSION 0

/* Define to the PLib micro version */
#define PLIB_MICRO_VERSION 1

/* Define to the PLib minor version */
#define PLIB_MINOR_VERSION 0
